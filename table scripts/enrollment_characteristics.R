...
d <- readRDS("/Users/gabby/Downloads/bangladesh-cleaned-master-data.RDS") %>% filter(.$pregnancy_immune == 1)
...
mom <- c('momage', 'momheight', 'momeduy')
...
save_as_docx("Table 1" = tbl1flex, path="~/WASH Benefits/ipv-dep-stress-immune/tables/main/enrollment_characteristics_figure_DRAFT.jpg", 
