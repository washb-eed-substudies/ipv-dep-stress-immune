...
dgrowth_spline <- readRDS(here("figure-data/delta_growth_adj_spline_data.RDS"))

#load results for quartiles
H1_quartiles <- readRDS(here("results/H1_adj_res.RDS"))
H2_quartiles <- readRDS(here("results/H2_adj_res.RDS"))
H3_quartiles <- readRDS(here("results/adjusted/H3_adj_res.RDS"))
dgrowth_quartiles <- readRDS(here("results/adjusted/delta_growth_adj_res.RDS"))
